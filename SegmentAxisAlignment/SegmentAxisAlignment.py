...
class SegmentAxisAlignmentWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def updateGUIFromParameterNode(self, caller=None, event=None):
    ...
    alignmentComputed = (self._parameterNode.GetParameter("OutputAlignmentAngleLR") != '' and self._parameterNode.GetParameter("OutputAlignmentAnglePA") != '')
    if alignmentComputed:
      ...
      self.ui.resultsLabel.text = f"Alignment angles computed: LR: {angleLR:.2f}°, PA: {anglePA:.2f}°"
    else:
